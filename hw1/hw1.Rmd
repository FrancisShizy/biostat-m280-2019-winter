...
author: "Zanyu Shi <zyshi@g.ucla.edu>"
...
```{bash}
awk 'END { print NR }' /home/m280data/NYCHVS/NYCHVS_1991.csv 
awk 'END { print NR }' /home/m280data/NYCHVS/NYCHVS_1993.csv
awk 'END { print NR }' /home/m280data/NYCHVS/NYCHVS_1996.csv
awk 'END { print NR }' /home/m280data/NYCHVS/NYCHVS_1999.csv
awk 'END { print NR }' /home/m280data/NYCHVS/NYCHVS_2002.csv
awk 'END { print NR }' /home/m280data/NYCHVS/NYCHVS_2005.csv
awk 'END { print NR }' /home/m280data/NYCHVS/NYCHVS_2008.csv
awk 'END { print NR }' /home/m280data/NYCHVS/NYCHVS_2011.csv
awk 'END { print NR }' /home/m280data/NYCHVS/NYCHVS_2014.csv
awk 'END { print NR }' /home/m280data/NYCHVS/NYCHVS_2017.csv 
```
...
```{bash}
  ...
  do grep -o $character /home/zyshi/biostat-m280-2019-winter/hw1/pride_and_prejudice.txt | uniq -c
  done
```
...
0. What's the difference between the following two commands?
    ...
    ```
The first command with ">"" menas directing output "hello, world" to text1.txt.
...
The first line of the shell script tells the file is "./~.sh" format file.
...
```{bash}
R CMD BATCH '--args seed=123 n=100 dist="gaussian" rep=20' /home/zyshi/Hua-Zhou.github.io/teaching/biostatm280-2019winter/slides/02-linux/runSim.R
```

```{bash}
R CMD BATCH '--args seed=123 n=100 dist="t1" rep=20' /home/zyshi/Hua-Zhou.github.io/teaching/biostatm280-2019winter/slides/02-linux/runSim.R
```

```{bash}
R CMD BATCH '--args seed=123 n=100 dist="t5" rep=20' /home/zyshi/Hua-Zhou.github.io/teaching/biostatm280-2019winter/slides/02-linux/runSim.R
```
