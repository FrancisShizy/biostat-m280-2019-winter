...
```{bash}
  ...
  do grep -o $character 
  /home/zyshi/biostat-m280-2019-winter/hw1/pride_and_prejudice.txt | uniq -c
  done
```
...
```{bash}
Rscript runSim.R seed=123 n=100 dist=\"gaussian\" rep=100
```

```{bash}
Rscript runSim.R  seed=123 n=100 dist=\"t1\" rep=100
```
